...
// ====================================================
const ptableData = [
    { num: 1, sym: 'H', name: 'Hydrogen', mass: '1.008 u', cat: 'nonmetal', phase: 'Gas', en: '2.20', conf: '1s¹', flame: 'Pale Blue', desc: 'Lightest element in the universe. Highly reactive diatomic gas yielding pure water vapor upon combustion.', role: 'Universal proton donor & primary building block of organic molecules' },
    { num: 2, sym: 'He', name: 'Helium', mass: '4.0026 u', cat: 'noble', phase: 'Gas', en: '—', conf: '1s²', flame: 'Peach / Gold', desc: 'Inert noble gas. Second most abundant element in the cosmos.', role: 'Cryogenic cooling & unreactive carrier gas in thermodynamics' },
    { num: 3, sym: 'Li', name: 'Lithium', mass: '6.94 u', cat: 'alkali', phase: 'Solid', en: '0.98', conf: '[He] 2s¹', flame: 'Crimson Red', desc: 'Lightest metal. Reacts vigorously with water to form lithium hydroxide and hydrogen.', role: 'High electrochemical potential batteries & organolithium synthesis' },
    { num: 4, sym: 'Be', name: 'Beryllium', mass: '9.0122 u', cat: 'alkaline', phase: 'Solid', en: '1.57', conf: '[He] 2s²', flame: 'White', desc: 'Steel-gray alkaline earth metal with exceptional thermal conductivity and stiffness.', role: 'Aerospace structural alloys & specialized X-ray tube windows' },
    { num: 5, sym: 'B', name: 'Boron', mass: '10.81 u', cat: 'metalloid', phase: 'Solid', en: '2.04', conf: '[He] 2s² 2p¹', flame: 'Bright Green', desc: 'Semimetal forming unique electron-deficient multicenter bonds.', role: 'Borane reduction chemistry & Lewis acid catalysis' },
    { num: 6, sym: 'C', name: 'Carbon', mass: '12.011 u', cat: 'nonmetal', phase: 'Solid', en: '2.55', conf: '[He] 2s² 2p²', flame: 'Yellow / Orange', desc: 'The backbone of all organic life. Capable of sp³, sp², and sp orbital hybridization.', role: 'Organic synthesis, catenation, aromatic rings, and graphene structures' },
    ...
    { num: 10, sym: 'Ne', name: 'Neon', mass: '20.180 u', cat: 'noble', phase: 'Gas', en: '—', conf: '[He] 2s² 2p⁶', flame: 'Red-Orange Glow', desc: 'Inert noble gas glowing intense reddish-orange under electric excitation.', role: 'Cryogenic refrigeration & electrical discharge indicators' },
    { num: 11, sym: 'Na', name: 'Sodium', mass: '22.990 u', cat: 'alkali', phase: 'Solid', en: '0.93', conf: '[Ne] 3s¹', flame: 'Intense Yellow', desc: 'Soft alkali metal reacting rapidly with water with explosive hydrogen evolution.', role: 'Salt electrolytes, sodium amide synthesis, and energetic reductions' },
    { num: 12, sym: 'Mg', name: 'Magnesium', mass: '24.305 u', cat: 'alkaline', phase: 'Solid', en: '1.31', conf: '[Ne] 3s²', flame: 'Brilliant White', desc: 'Light structural metal combusting with a blinding white flame.', role: 'Grignard reagents (R-Mg-X) for universal carbon-carbon coupling' },
    { num: 13, sym: 'Al', name: 'Aluminium', mass: '26.982 u', cat: 'post-transition', phase: 'Solid', en: '1.61', conf: '[Ne] 3s² 3p¹', flame: 'Silver White', desc: 'Low density, high conductivity metal protected by a natural Al₂O₃ oxide layer.', role: 'Alloy metallurgy, Friedel-Crafts AlCl₃ catalyst, and thermite fuels' },
    { num: 14, sym: 'Si', name: 'Silicon', mass: '28.085 u', cat: 'metalloid', phase: 'Solid', en: '1.90', conf: '[Ne] 3s² 3p²', flame: 'White', desc: 'Tetravalent metalloid forming the foundation of microchips and silicate minerals.', role: 'Semiconductors, silicones, and quartz network structures' },
    { num: 15, sym: 'P', name: 'Phosphorus', mass: '30.974 u', cat: 'nonmetal', phase: 'Solid', en: '2.19', conf: '[Ne] 3s² 3p³', flame: 'Pale Green-White', desc: 'Exists as white, red, and black allotropes. Central to cellular ATP energy cycles.', role: 'Phosphate DNA backbone, organophosphates, and Wittig reagents' },
    { num: 16, sym: 'S', name: 'Sulfur', mass: '32.06 u', cat: 'nonmetal', phase: 'Solid', en: '2.58', conf: '[Ne] 3s² 3p⁴', flame: 'Blue', desc: 'Bright yellow nonmetal forming octasulfur (S₈) crown rings.', role: 'Sulfuric acid manufacturing, disulfide protein bridges, and vulcanization' },
    { num: 17, sym: 'Cl', name: 'Chlorine', mass: '35.45 u', cat: 'halogen', phase: 'Gas', en: '3.16', conf: '[Ne] 3s² 3p⁵', flame: 'Greenish-Yellow', desc: 'Pungent greenish-yellow halogen gas and powerful disinfecting oxidant.', role: 'Halogenation reactions, chlorination, and hydrochloric acid synthesis' },
    { num: 18, sym: 'Ar', name: 'Argon', mass: '39.948 u', cat: 'noble', phase: 'Gas', en: '—', conf: '[Ne] 3s² 3p⁶', flame: 'Lilac / Blue-Violet', desc: 'Most abundant atmospheric noble gas (~0.93%), inert under standard conditions.', role: 'Inert gas blanket for high-temperature synthesis & arc welding' },
    { num: 19, sym: 'K', name: 'Potassium', mass: '39.098 u', cat: 'alkali', phase: 'Solid', en: '0.82', conf: '[Ar] 4s¹', flame: 'Lilac / Violet', desc: 'Reacts violently with water with an immediate lilac flame ignition.', role: 'Cellular ion pumps, superoxide formation, and potash fertilizers' },
    { num: 20, sym: 'Ca', name: 'Calcium', mass: '40.078 u', cat: 'alkaline', phase: 'Solid', en: '1.00', conf: '[Ar] 4s²', flame: 'Brick Red', desc: 'Essential mineral for biological bone matrix (hydroxyapatite) and cement.', role: 'Desulfurization, biological signaling cascades, and calcium oxide flux' },
    { num: 21, sym: 'Sc', name: 'Scandium', mass: '44.956 u', cat: 'transition', phase: 'Solid', en: '1.36', conf: '[Ar] 3d¹ 4s²', flame: 'Yellow-Orange', desc: 'Lightweight transition metal that strengthens high-performance aluminium alloys.', role: 'Aerospace structural alloys & metal-halide stadium lamps' },
    { num: 22, sym: 'Ti', name: 'Titanium', mass: '47.867 u', cat: 'transition', phase: 'Solid', en: '1.54', conf: '[Ar] 3d² 4s²', flame: 'Bright White Sparks', desc: 'Corrosion-resistant metal with the highest strength-to-density ratio.', role: 'Ziegler-Natta polymerization catalysis & biocompatible implants' },
    { num: 23, sym: 'V', name: 'Vanadium', mass: '50.942 u', cat: 'transition', phase: 'Solid', en: '1.63', conf: '[Ar] 3d³ 4s²', flame: 'Yellow-Green', desc: 'Transition metal with colorful oxidation states (V²⁺, V³⁺, VO²⁺, VO₂⁺).', role: 'Vanadium redox flow batteries & high-strength tool steels' },
    { num: 24, sym: 'Cr', name: 'Chromium', mass: '51.996 u', cat: 'transition', phase: 'Solid', en: '1.66', conf: '[Ar] 3d⁵ 4s¹', flame: 'Silver / Blue-White', desc: 'Hard, lustrous metal providing corrosion resistance in stainless steel.', role: 'Jones reagent alcohol oxidation & decorative chrome electroplating' },
    { num: 25, sym: 'Mn', name: 'Manganese', mass: '54.938 u', cat: 'transition', phase: 'Solid', en: '1.55', conf: '[Ar] 3d⁵ 4s²', flame: 'Greenish-White', desc: 'Versatile element key to photosynthesis water-splitting cluster (Mn₄CaO₅).', role: 'Potassium permanganate (KMnO₄) redox titrations & battery cathodes' },
    { num: 26, sym: 'Fe', name: 'Iron', mass: '55.845 u', cat: 'transition', phase: 'Solid', en: '1.83', conf: '[Ar] 3d⁶ 4s²', flame: 'Gold Sparkles', desc: 'Most abundant element by mass on Earth; central to hemoglobin oxygen transport.', role: 'Haber-Bosch ammonia catalyst, steel alloy forger, and redox chemistry' },
    { num: 27, sym: 'Co', name: 'Cobalt', mass: '58.933 u', cat: 'transition', phase: 'Solid', en: '1.88', conf: '[Ar] 3d⁷ 4s²', flame: 'Silver-White', desc: 'Ferromagnetic transition metal at the core of Vitamin B12 (cobalamin).', role: 'Lithium-ion battery cathodes (NMC) and superalloy turbine blades' },
    { num: 28, sym: 'Ni', name: 'Nickel', mass: '58.693 u', cat: 'transition', phase: 'Solid', en: '1.91', conf: '[Ar] 3d⁸ 4s²', flame: 'Silver', desc: 'Corrosion-resistant metal vital for electroplating and coin minting.', role: 'Raney nickel catalytic hydrogenation of alkenes to alkanes' },
    { num: 29, sym: 'Cu', name: 'Copper', mass: '63.546 u', cat: 'transition', phase: 'Solid', en: '1.90', conf: '[Ar] 3d¹⁰ 4s¹', flame: 'Emerald Green', desc: 'Reddish metal with exceptional electrical and thermal conductivity.', role: 'Click chemistry (CuAAC), organocuprates, and electrical wiring' },
    { num: 30, sym: 'Zn', name: 'Zinc', mass: '65.38 u', cat: 'transition', phase: 'Solid', en: '1.65', conf: '[Ar] 3d¹⁰ 4s²', flame: 'Bluish-Green', desc: 'Corrosion protector for galvanizing steel; vital for carbonic anhydrase enzyme.', role: 'Clemmensen reduction, brass alloys, and alkaline battery anodes' },
    { num: 31, sym: 'Ga', name: 'Gallium', mass: '69.723 u', cat: 'post-transition', phase: 'Solid (Melts 29.8°C)', en: '1.81', conf: '[Ar] 3d¹⁰ 4s² 4p¹', flame: 'Violet', desc: 'Metal that literally melts in the palm of your hand at 29.8°C.', role: 'Gallium arsenide (GaAs) lasers, optoelectronics, and liquid metal alloys' },
    { num: 32, sym: 'Ge', name: 'Germanium', mass: '72.630 u', cat: 'metalloid', phase: 'Solid', en: '2.01', conf: '[Ar] 3d¹⁰ 4s² 4p²', flame: 'Pale Blue', desc: 'Lustrous, hard metalloid pivotal in early transistor semiconductors.', role: 'Fiber optics, infrared spectroscopy lenses, and solar cells' },
    { num: 33, sym: 'As', name: 'Arsenic', mass: '74.922 u', cat: 'metalloid', phase: 'Solid', en: '2.18', conf: '[Ar] 3d¹⁰ 4s² 4p³', flame: 'Pale Blue', desc: 'Notorious toxic metalloid forming sulfides and oxide complexes.', role: 'Semiconductor n-type dopant and III-V optoelectronic compounds' },
    { num: 34, sym: 'Se', name: 'Selenium', mass: '78.971 u', cat: 'nonmetal', phase: 'Solid', en: '2.55', conf: '[Ar] 3d¹⁰ 4s² 4p⁴', flame: 'Azure Blue', desc: 'Photoconductive nonmetal whose electrical conductivity surges under light.', role: 'Photocells, selenoproteins (glutathione peroxidase), and glass coloring' },
    { num: 35, sym: 'Br', name: 'Bromine', mass: '79.904 u', cat: 'halogen', phase: 'Liquid', en: '2.96', conf: '[Ar] 3d¹⁰ 4s² 4p⁵', flame: 'Reddish-Brown', desc: 'The only liquid nonmetallic element at room temperature, fuming intensely.', role: 'Electrophilic alkene addition & radical allylic bromination (NBS)' },
    { num: 36, sym: 'Kr', name: 'Krypton', mass: '83.798 u', cat: 'noble', phase: 'Gas', en: '3.00', conf: '[Ar] 3d¹⁰ 4s² 4p⁶', flame: 'Whitish-Blue', desc: 'Heavy noble gas used in high-speed photographic strobe lamps.', role: 'Excimer lasers (KrF) for semiconductor nanolithography' },
    { num: 37, sym: 'Rb', name: 'Rubidium', mass: '85.468 u', cat: 'alkali', phase: 'Solid', en: '0.82', conf: '[Kr] 5s¹', flame: 'Red-Violet', desc: 'Pyrophoric alkali metal that ignites in air and explodes on contact with water.', role: 'Atomic clocks, photocells, and vapor cell laser spectroscopy' },
    { num: 38, sym: 'Sr', name: 'Strontium', mass: '87.62 u', cat: 'alkaline', phase: 'Solid', en: '0.95', conf: '[Kr] 5s²', flame: 'Deep Crimson', desc: 'Soft alkaline earth metal imparting vivid red colors in emergency flares.', role: 'Pyrotechnic crimson illuminations and strontium titanate optics' },
    { num: 39, sym: 'Y', name: 'Yttrium', mass: '88.906 u', cat: 'transition', phase: 'Solid', en: '1.22', conf: '[Kr] 4d¹ 5s²', flame: 'Bright Red', desc: 'Rare-earth-like transition metal key in YBCO high-temperature superconductors.', role: 'YAG laser crystals (Nd:YAG) and superconducting ceramic matrices' },
    { num: 40, sym: 'Zr', name: 'Zirconium', mass: '91.224 u', cat: 'transition', phase: 'Solid', en: '1.33', conf: '[Kr] 4d² 5s²', flame: 'Bright White', desc: 'Extremely corrosion-resistant metal with very low thermal neutron absorption.', role: 'Nuclear reactor fuel cladding and cubic zirconia gemstone ceramics' },
    { num: 41, sym: 'Nb', name: 'Niobium', mass: '92.906 u', cat: 'transition', phase: 'Solid', en: '1.60', conf: '[Kr] 4d⁴ 5s¹', flame: 'Bluish-White', desc: 'Superconducting transition metal used in MRI magnet windings (NbTi).', role: 'Superconducting particle accelerator RF cavities and microalloyed steel' },
    { num: 42, sym: 'Mo', name: 'Molybdenum', mass: '95.95 u', cat: 'transition', phase: 'Solid', en: '2.16', conf: '[Kr] 4d⁵ 5s¹', flame: 'Yellow-Green', desc: 'Refractory metal with one of the highest melting points (2,623°C).', role: 'Nitrogenase biological nitrogen-fixation cofactor and molybdenum disulfide lubricant' },
    { num: 43, sym: 'Tc', name: 'Technetium', mass: '98 u', cat: 'transition', phase: 'Solid', en: '1.90', conf: '[Kr] 4d⁵ 5s²', flame: 'Radioactive Glow', desc: 'The lowest atomic-numbered element with no stable isotopes; synthetically produced.', role: 'Nuclear medicine medical diagnostic imaging (Tc-99m radiotracers)' },
    { num: 44, sym: 'Ru', name: 'Ruthenium', mass: '101.07 u', cat: 'transition', phase: 'Solid', en: '2.20', conf: '[Kr] 4d⁷ 5s¹', flame: 'White-Hot', desc: 'Platinum group metal renowned for Grubbs olefin metathesis catalysts.', role: 'Nobel-winning olefin metathesis catalysis in organic synthesis' },
    { num: 45, sym: 'Rh', name: 'Rhodium', mass: '102.91 u', cat: 'transition', phase: 'Solid', en: '2.28', conf: '[Kr] 4d⁸ 5s¹', flame: 'Silver', desc: 'Precious, reflective metal catalytic in decomposing automotive NOx emissions.', role: 'Automotive 3-way catalytic converters and Wilkinson hydrogenation catalyst' },
    { num: 46, sym: 'Pd', name: 'Palladium', mass: '106.42 u', cat: 'transition', phase: 'Solid', en: '2.20', conf: '[Kr] 4d¹⁰', flame: 'Silver-White', desc: 'Absorbs up to 900 times its own volume of hydrogen gas like a metal sponge.', role: 'Suzuki-Miyaura cross-coupling catalysts and hydrogen fuel purification' },
    { num: 47, sym: 'Ag', name: 'Silver', mass: '107.87 u', cat: 'transition', phase: 'Solid', en: '1.93', conf: '[Kr] 4d¹⁰ 5s¹', flame: 'Faint Greenish', desc: 'Highest electrical conductivity, thermal conductivity, and reflectivity of all metals.', role: 'Tollens silver-mirror aldehyde test, photography, and conductive inks' },
    { num: 48, sym: 'Cd', name: 'Cadmium', mass: '112.41 u', cat: 'transition', phase: 'Solid', en: '1.69', conf: '[Kr] 4d¹⁰ 5s²', flame: 'Brick Red', desc: 'Soft, bluish metal used in rechargeable NiCd batteries and quantum dots.', role: 'Cadmium selenide (CdSe) quantum dot fluorescence and neutron shielding' },
    { num: 49, sym: 'In', name: 'Indium', mass: '114.82 u', cat: 'post-transition', phase: 'Solid', en: '1.78', conf: '[Kr] 4d¹⁰ 5s² 5p¹', flame: 'Indigo Blue', desc: 'Soft metal that squeaks when bent. Key ingredient in transparent touchscreens (ITO).', role: 'Indium tin oxide (ITO) transparent touchscreen conductor coatings' },
    { num: 50, sym: 'Sn', name: 'Tin', mass: '118.71 u', cat: 'post-transition', phase: 'Solid', en: '1.96', conf: '[Kr] 4d¹⁰ 5s² 5p²', flame: 'Pale Violet', desc: 'Ancient alloy component in bronze; exhibits tin pest allotropic transformation below 13°C.', role: 'Soldering electronics, Stille cross-coupling organotins, and corrosion coating' },
    { num: 51, sym: 'Sb', name: 'Antimony', mass: '121.76 u', cat: 'metalloid', phase: 'Solid', en: '2.05', conf: '[Kr] 4d¹⁰ 5s² 5p³', flame: 'Pale Green', desc: 'Lustrous metalloid whose pentafluoride (SbF₅) is the strongest known Lewis acid.', role: 'Core ingredient in Fluoroantimonic Acid (HSbF₆) superacid synthesis' },
    { num: 52, sym: 'Te', name: 'Tellurium', mass: '127.60 u', cat: 'metalloid', phase: 'Solid', en: '2.10', conf: '[Kr] 4d¹⁰ 5s² 5p⁴', flame: 'Greenish-Blue', desc: 'Brittle silvery metalloid forming cadmium telluride (CdTe) solar panel thin films.', role: 'High-efficiency thin-film solar photovoltaics and thermoelectric coolers' },
    { num: 53, sym: 'I', name: 'Iodine', mass: '126.90 u', cat: 'halogen', phase: 'Solid', en: '2.66', conf: '[Kr] 4d¹⁰ 5s² 5p⁵', flame: 'Deep Violet Vapor', desc: 'Lustrous purple-black solid that sublimes directly into a gorgeous violet gas.', role: 'Starch iodine test, thyroid hormone synthesis, and radical initiator' },
    { num: 54, sym: 'Xe', name: 'Xenon', mass: '131.29 u', cat: 'noble', phase: 'Gas', en: '2.60', conf: '[Kr] 4d¹⁰ 5s² 5p⁶', flame: 'Sky Blue Glow', desc: 'Dense noble gas capable of forming true fluorides and oxides (XeF₂, XeF₄, XeF₆).', role: 'Spacecraft ion propulsion thrusters and deep anesthesia agents' },
    { num: 55, sym: 'Cs', name: 'Caesium', mass: '132.91 u', cat: 'alkali', phase: 'Solid (Liquid >28°C)', en: '0.79', conf: '[Xe] 6s¹', flame: 'Sky Blue', desc: 'Most reactive stable metal. Melts at 28.5°C; detonates violently on contact with ice.', role: 'SI definition of the second (atomic hyperfine transition at 9.192 GHz)' },
    { num: 56, sym: 'Ba', name: 'Barium', mass: '137.33 u', cat: 'alkaline', phase: 'Solid', en: '0.89', conf: '[Xe] 6s²', flame: 'Apple Green', desc: 'Highly reactive alkaline earth metal giving brilliant apple-green fireworks.', role: 'Barium sulfate GI contrast imaging and green pyrotechnics' },
    { num: 57, sym: 'La', name: 'Lanthanum', mass: '138.91 u', cat: 'lanthanide', phase: 'Solid', en: '1.10', conf: '[Xe] 5d¹ 6s²', flame: 'White', desc: 'Soft silvery metal that names the entire Lanthanide series of 4f elements.', role: 'Hybrid vehicle battery nickel-metal hydride (NiMH) electrodes' },
    { num: 58, sym: 'Ce', name: 'Cerium', mass: '140.12 u', cat: 'lanthanide', phase: 'Solid', en: '1.12', conf: '[Xe] 4f¹ 5d¹ 6s²', flame: 'White Sparks', desc: 'Most abundant rare-earth metal. Flints spark when scraped; CAN is a premier oxidant.', role: 'Cerium(IV) ammonium nitrate (CAN) single-electron oxidant in organics' },
    { num: 59, sym: 'Pr', name: 'Praseodymium', mass: '140.91 u', cat: 'lanthanide', phase: 'Solid', en: '1.13', conf: '[Xe] 4f³ 6s²', flame: 'Pale Yellow', desc: 'Soft ductile metal creating didymium glass to block intense sodium yellow glare.', role: 'Glassblowers safety goggles and ultra-strong neodymium alloy magnets' },
    { num: 60, sym: 'Nd', name: 'Neodymium', mass: '144.24 u', cat: 'lanthanide', phase: 'Solid', en: '1.14', conf: '[Xe] 4f⁴ 6s²', flame: 'Yellow', desc: 'Forms the most powerful permanent magnets known to science (Nd₂Fe₁₄B).', role: 'Permanent magnets for electric vehicle motors, wind turbines, and hard drives' },
    { num: 61, sym: 'Pm', name: 'Promethium', mass: '145 u', cat: 'lanthanide', phase: 'Solid', en: '1.13', conf: '[Xe] 4f⁵ 6s²', flame: 'Radioactive Glow', desc: 'Extremely rare radioactive lanthanide used in atomic batteries.', role: 'Miniature nuclear-powered batteries for spacecraft instruments' },
    { num: 62, sym: 'Sm', name: 'Samarium', mass: '150.36 u', cat: 'lanthanide', phase: 'Solid', en: '1.17', conf: '[Xe] 4f⁶ 6s²', flame: 'Yellow', desc: 'Lanthanide forming heat-resistant Samarium-Cobalt (SmCo) magnets.', role: 'Samarium diiodide (SmI₂) Kagan reagent for single-electron reductions' },
    { num: 63, sym: 'Eu', name: 'Europium', mass: '151.96 u', cat: 'lanthanide', phase: 'Solid', en: '1.20', conf: '[Xe] 4f⁷ 6s²', flame: 'Crimson Glow', desc: 'Most reactive lanthanide metal; glows brilliant red under UV light.', role: 'Anti-counterfeiting phosphors in Euro banknotes and color TV screens' },
    { num: 64, sym: 'Gd', name: 'Gadolinium', mass: '157.25 u', cat: 'lanthanide', phase: 'Solid', en: '1.20', conf: '[Xe] 4f⁷ 5d¹ 6s²', flame: 'White', desc: 'Possesses 7 unpaired f-electrons giving extraordinary paramagnetic resonance.', role: 'MRI magnetic resonance contrast enhancement agents' },
    { num: 65, sym: 'Tb', name: 'Terbium', mass: '158.93 u', cat: 'lanthanide', phase: 'Solid', en: '1.20', conf: '[Xe] 4f⁹ 6s²', flame: 'Green Glow', desc: 'Rare-earth metal emitting a characteristic intense green fluorescent peak.', role: 'Magnetostrictive Terfenol-D naval sonars and fluorescent green lamps' },
    { num: 66, sym: 'Dy', name: 'Dysprosium', mass: '162.50 u', cat: 'lanthanide', phase: 'Solid', en: '1.22', conf: '[Xe] 4f¹⁰ 6s²', flame: 'Silver', desc: 'Highest magnetic strength of any element at cryogenic temperatures.', role: 'Thermal stabilization of electric vehicle neodymium motor magnets' },
    { num: 67, sym: 'Ho', name: 'Holmium', mass: '164.93 u', cat: 'lanthanide', phase: 'Solid', en: '1.23', conf: '[Xe] 4f¹¹ 6s²', flame: 'Yellow', desc: 'Has the highest magnetic moment of any naturally occurring element.', role: 'Medical holmium-YAG lasers for non-invasive surgical kidney stone ablation' },
    { num: 68, sym: 'Er', name: 'Erbium', mass: '167.26 u', cat: 'lanthanide', phase: 'Solid', en: '1.24', conf: '[Xe] 4f¹² 6s²', flame: 'Pink Glow', desc: 'Pink-colored lanthanide ion amplifying optical communication signals.', role: 'Erbium-doped fiber amplifiers (EDFAs) powering global internet cables' },
    { num: 69, sym: 'Tm', name: 'Thulium', mass: '168.93 u', cat: 'lanthanide', phase: 'Solid', en: '1.25', conf: '[Xe] 4f¹³ 6s²', flame: 'Silver', desc: 'Second rarest naturally occurring lanthanide; produces clean portable X-rays.', role: 'Portable medical X-ray sources and high-efficiency solid-state lasers' },
    { num: 70, sym: 'Yb', name: 'Ytterbium', mass: '173.05 u', cat: 'lanthanide', phase: 'Solid', en: '1.10', conf: '[Xe] 4f¹⁴ 6s²', flame: 'Silver', desc: 'Soft ductile metal with a completely filled 4f¹⁴ subshell.', role: 'Atomic optical clocks with precision exceeding 1 part in 10¹⁸' },
    { num: 71, sym: 'Lu', name: 'Lutetium', mass: '174.97 u', cat: 'lanthanide', phase: 'Solid', en: '1.27', conf: '[Xe] 4f¹⁴ 5d¹ 6s²', flame: 'White', desc: 'The heaviest and hardest of the lanthanide elements.', role: 'Lutetium-177 targeted radioligand cancer therapy (Lu-177 PSMA)' },
    { num: 72, sym: 'Hf', name: 'Hafnium', mass: '178.49 u', cat: 'transition', phase: 'Solid', en: '1.30', conf: '[Xe] 4f¹⁴ 5d² 6s²', flame: 'White', desc: 'High neutron-capture transition metal that twins zirconium chemically.', role: 'High-k dielectric gate insulators in sub-10nm microprocessors' },
    { num: 73, sym: 'Ta', name: 'Tantalum', mass: '180.95 u', cat: 'transition', phase: 'Solid', en: '1.50', conf: '[Xe] 4f¹⁴ 5d³ 6s²', flame: 'Silver', desc: 'Extremely inert metal completely immune to attack by bodily fluids and acids.', role: 'Miniature high-capacitance smartphone capacitors & surgical implants' },
    { num: 74, sym: 'W', name: 'Tungsten', mass: '183.84 u', cat: 'transition', phase: 'Solid', en: '2.36', conf: '[Xe] 4f¹⁴ 5d⁴ 6s²', flame: 'Incandescent White', desc: 'Possesses the highest melting point of all elements on Earth (3,422°C).', role: 'Ultra-hard tungsten carbide (WC) cutting bits and fusion reactor armor' },
    { num: 75, sym: 'Re', name: 'Rhenium', mass: '186.21 u', cat: 'transition', phase: 'Solid', en: '1.90', conf: '[Xe] 4f¹⁴ 5d⁵ 6s²', flame: 'Silver', desc: 'One of the rarest elements in Earth crust with third highest melting point.', role: 'Single-crystal superalloys for jet engine combustion turbine blades' },
    { num: 76, sym: 'Os', name: 'Osmium', mass: '190.23 u', cat: 'transition', phase: 'Solid', en: '2.20', conf: '[Xe] 4f¹⁴ 5d⁶ 6s²', flame: 'Bluish-White', desc: 'The densest naturally occurring element (22.59 g/cm³); twice as dense as lead.', role: 'Osmium tetroxide (OsO₄) stereospecific syn-dihydroxylation of alkenes' },
    { num: 77, sym: 'Ir', name: 'Iridium', mass: '192.22 u', cat: 'transition', phase: 'Solid', en: '2.20', conf: '[Xe] 4f¹⁴ 5d⁷ 6s²', flame: 'Silver', desc: 'The most corrosion-resistant metal known; enriched in the asteroid extinction layer.', role: 'Spark plug electrodes and polymer electrolyte membrane water electrolyzers' },
    { num: 78, sym: 'Pt', name: 'Platinum', mass: '195.08 u', cat: 'transition', phase: 'Solid', en: '2.28', conf: '[Xe] 4f¹⁴ 5d⁹ 6s¹', flame: 'Silver', desc: 'Noble metal resistant to oxidation and corrosion; essential in chemo medicine.', role: 'Cisplatin chemotherapy drug & hydrogen fuel cell catalytic electrodes' },
    ...
    { num: 80, sym: 'Hg', name: 'Mercury', mass: '200.59 u', cat: 'transition', phase: 'Liquid', en: '2.00', conf: '[Xe] 4f¹⁴ 5d¹⁰ 6s²', flame: 'Bluish-Green', desc: 'The only metallic element that is liquid at standard temperature and pressure.', role: 'Oxymercuration-demercuration Markovnikov hydration of alkenes' },
    { num: 81, sym: 'Tl', name: 'Thallium', mass: '204.38 u', cat: 'post-transition', phase: 'Solid', en: '1.62', conf: '[Xe] 4f¹⁴ 5d¹⁰ 6s² 6p¹', flame: 'Pure Green', desc: 'Soft toxic metal whose spectrum exhibits a distinctive green emission line.', role: 'Infrared optical materials and medical myocardial perfusion imaging' },
    { num: 82, sym: 'Pb', name: 'Lead', mass: '207.2 u', cat: 'post-transition', phase: 'Solid', en: '2.33', conf: '[Xe] 4f¹⁴ 5d¹⁰ 6s² 6p²', flame: 'Faint Blue-White', desc: 'Dense malleable metal that marks the terminus of natural radioactive decay chains.', role: 'Lead-acid vehicle batteries and high-energy radiation X-ray shielding' },
    { num: 83, sym: 'Bi', name: 'Bismuth', mass: '208.98 u', cat: 'post-transition', phase: 'Solid', en: '2.02', conf: '[Xe] 4f¹⁴ 5d¹⁰ 6s² 6p³', flame: 'Azure Blue', desc: 'Heaviest stable sandbox element. Forms iridescent hopper-crystal oxide staircases.', role: 'Pepto-Bismol subsalicylate pharmaceuticals and non-toxic lead substitutes' },
    { num: 87, sym: 'Fr', name: 'Francium', mass: '223 u', cat: 'alkali', phase: 'Solid / Molten', en: '0.70', conf: '[Rn] 7s¹', flame: 'Intense Ionizing Green', desc: 'Extremely radioactive alkali metal; highest theoretical alkali detonation yield.', role: 'Maximum alkali blast detonation yield & nuclear ionization shockwave physics' }
];
